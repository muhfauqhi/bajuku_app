            ...
            return Container(
              ...
              child: Column(
                children: <Widget>[
                    ...
                    child: Column(
                      children: <Widget>[
                        Container(
                          ...
                          child: Text(
                            snapshot
                                .data.documents[widget.idx].data['clothName'],
                            style: TextStyle(
                              fontSize: 16.0,
                        ...
                        Row(
                          children: <Widget>[
                            Container(
                              ...
                              child: Text(
                                snapshot.data.documents[widget.idx].data['worn']
                                        .toString() +
                                    ' times worn',
                                style: TextStyle(
                                  fontSize: 16.0,
                            ...
                            Container(
                              ...
                              child: Text(
                                'Last worn ' +
                                    snapshot
                                        .data.documents[widget.idx].data['worn']
                                        .toString() +
                                    ' days ago',
                  ...
                  _buildContainerListLight(
                      'Size', snapshot.data.documents[widget.idx].data['size']),
                  ...
                  _buildContainerListDark(
                      'Used in Outfit',
                      snapshot.data.documents[widget.idx].data['usedInOutfit']
                          .toString()),
                  _buildContainerListLight(
                      'Tags Category',
